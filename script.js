...
class NewsSystem {
    static render() {
        ...
        const d = StorageService.get(AppConfig.storage.keys.NEWS)||[{title:"Info Terbaru!", content:"Raffa Store kini hadir dengan tampilan baru yang lebih segar dan mudah digunakan.", date:"System"},{
            title:"Selamat Datang!", content:"Top Up Game 24 Jam Nonstop & Amanah.", date:"System"}];
...
const FakeNotif = {
    ...
    products: [ 
        ...
        { name: "300 Gold Genshin", icon: "🪙" },
        { name: "500 V-Bucks", icon: "🎮" }
    ],
